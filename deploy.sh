...
az aks get-credentials --resource-group  --name EPAM_Diploma --admin --overwrite-existing
...
docker tag nhlapi:$COMMIT_ID dfdf.azmk8s.io/nhlapp:$COMMIT_ID
docker push k8stest-5cdc4cbc.hcp.centralus.azmk8s.io/nhlapp:$COMMIT_ID
...
Development environment:
    ...
    http://epamdiploma.eastus.cloudapp.azure.com/

Production environment:

    http://epamdiplomaprod.eastus.cloudapp.azure.com/
